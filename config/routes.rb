Rails.application.routes.draw do
	...
	get 'business_math/practice/equations/:id'   => 'business_maths#equations',   as: 'equations_business_maths'
	get 'business_math/practice/programming/:id' => 'business_maths#programming', as: 'programming_business_maths'
	get 'business_math/practice/interest/:id'    => 'business_maths#interest',    as: 'interest_business_maths'
	get 'business_math/practice/probability/:id' => 'business_maths#probability', as: 'probability_business_maths'
	get 'business_math/practice/matrices/:id'    => 'business_maths#matrices',    as: 'matrices_business_maths'
